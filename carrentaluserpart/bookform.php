<html>
    <head>
      ...
      $sql1="select * from booking_tbl where bookid='$last_id'";
      $rs1=mysqli_query($cn,$sql1);
      $db1=mysqli_fetch_array($rs1);
      $source=$db1['source'];
      $destination=$db1['destination'];
    ...
    <body>
        <div class="table">
            ...
            <tr>
                ...
                <td id="blank"><?php echo $db2['routekm'];?></td>
            </tr>
            <tr>
                <td id="none">Total Payable Amount</td>
                <td id="blankk">&#8377;<?php echo $db['carrent']*$db2['routekm'];?></td>
            </tr>
        </table>
        <a href="check.php"><input type="submit" name="s1" class="buttton" value="CHECKOUT"></a>
        </div>
        <div class="summary">
