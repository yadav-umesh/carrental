<html>
    ...
    <body>
        ...
        {
        ?>
            <div class="head"><marquee scrollamount="20" behavior="alternate" onmouseover="this.stop();" onmouseout="this.start();"><?php echo $db['companyname'];?></marquee></div>
            <?php
            ...
            ?>
                <div class="frame">
                    ...
                    <a href="booknow.php?id=<?php echo $d['carid'];?>"><input type="submit" value="Book Now" class="book"></a>
                </div>
            <?php
            }
            ?>
